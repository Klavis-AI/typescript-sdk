...
export declare namespace XeroOauth {
...
export class XeroOauth {
    protected readonly _options: XeroOauth.Options;

    constructor(_options: XeroOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeXeroRequest} request
     * @param {XeroOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.XeroOAuthCallbackRequest} request
     * @param {XeroOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public xeroOAuthCallback(
        ...
        return core.HttpResponsePromise.fromPromise(this.__xeroOAuthCallback(request, requestOptions));
    }

    private async __xeroOAuthCallback(
        request: Klavis.XeroOAuthCallbackRequest = {},
        requestOptions?: XeroOauth.RequestOptions,
    ): Promise<core.WithRawResponse<unknown>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/xero/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *
     * @param {Klavis.RefreshXeroTokenEndpointOauthXeroRefreshTokenPostRequest} request
     * @param {XeroOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Klavis.BadRequestError}
     * @throws {@link Klavis.UnprocessableEntityError}
     ...
     *     })
     */
    public refreshXeroTokenEndpoint(
        request: Klavis.RefreshXeroTokenEndpointOauthXeroRefreshTokenPostRequest,
        requestOptions?: XeroOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.XeroOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__refreshXeroTokenEndpoint(request, requestOptions));
    }

    private async __refreshXeroTokenEndpoint(
        request: Klavis.RefreshXeroTokenEndpointOauthXeroRefreshTokenPostRequest,
        requestOptions?: XeroOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.XeroOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.XeroOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling POST /oauth/xero/refresh_token.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
