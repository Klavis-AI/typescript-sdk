...
export declare namespace GoogleCloudOauth {
...
export class GoogleCloudOauth {
    protected readonly _options: GoogleCloudOauth.Options;

    constructor(_options: GoogleCloudOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeGoogleCloudRequest} request
     * @param {GoogleCloudOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *     })
     */
    public authorizeGoogleCloud(
        request: Klavis.AuthorizeGoogleCloudRequest,
        requestOptions?: GoogleCloudOauth.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__authorizeGoogleCloud(request, requestOptions));
    }

    private async __authorizeGoogleCloud(
        request: Klavis.AuthorizeGoogleCloudRequest,
        requestOptions?: GoogleCloudOauth.RequestOptions,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/google-cloud/authorize.");
            case "unknown":
                throw new errors.KlavisError({
