...
export declare namespace ShopifyOauth {
...
export class ShopifyOauth {
    protected readonly _options: ShopifyOauth.Options;

    constructor(_options: ShopifyOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeShopifyRequest} request
     * @param {ShopifyOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
