...
export declare namespace YoutubeOauth {
...
export class YoutubeOauth {
    protected readonly _options: YoutubeOauth.Options;

    constructor(_options: YoutubeOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeYouTubeRequest} request
     * @param {YoutubeOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *     })
     */
    public authorizeYouTube(
        request: Klavis.AuthorizeYouTubeRequest,
        requestOptions?: YoutubeOauth.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__authorizeYouTube(request, requestOptions));
    }

    private async __authorizeYouTube(
        request: Klavis.AuthorizeYouTubeRequest,
        requestOptions?: YoutubeOauth.RequestOptions,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/youtube/authorize.");
            case "unknown":
                throw new errors.KlavisError({
