...
export declare namespace PipedriveOauth {
...
export class PipedriveOauth {
    protected readonly _options: PipedriveOauth.Options;

    constructor(_options: PipedriveOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizePipedriveRequest} request
     * @param {PipedriveOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
