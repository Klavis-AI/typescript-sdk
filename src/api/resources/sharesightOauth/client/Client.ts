...
export class SharesightOauth {
    ...
    /**
     * @param {Klavis.RefreshTokenOauthSharesightRefreshTokenPostRequest} request
     * @param {SharesightOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public refreshToken(
        ...
        requestOptions?: SharesightOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.SharesightOAuthSuccessResponse> {
    ...
    private async __refreshToken(
        request: Klavis.RefreshTokenOauthSharesightRefreshTokenPostRequest,
        requestOptions?: SharesightOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.SharesightOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Klavis.SharesightOAuthSuccessResponse,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError(
                    "Timeout exceeded when calling POST /oauth/sharesight/refresh_token.",
                );
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
