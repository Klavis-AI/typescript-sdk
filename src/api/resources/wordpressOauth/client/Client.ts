...
export declare namespace WordpressOauth {
...
export class WordpressOauth {
    protected readonly _options: WordpressOauth.Options;

    constructor(_options: WordpressOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeWordpressRequest} request
     * @param {WordpressOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.WordpressOAuthCallbackRequest} request
     * @param {WordpressOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public wordpressOAuthCallback(
        request: Klavis.WordpressOAuthCallbackRequest = {},
        requestOptions?: WordpressOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.WordPressOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__wordpressOAuthCallback(request, requestOptions));
    }

    private async __wordpressOAuthCallback(
        request: Klavis.WordpressOAuthCallbackRequest = {},
        requestOptions?: WordpressOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.WordPressOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.WordPressOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/wordpress/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
