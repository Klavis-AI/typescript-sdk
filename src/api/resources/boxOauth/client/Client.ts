...
export declare namespace BoxOauth {
...
export class BoxOauth {
    protected readonly _options: BoxOauth.Options;

    constructor(_options: BoxOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeBoxRequest} request
     * @param {BoxOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
