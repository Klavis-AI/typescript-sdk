...
export declare namespace ZohoMailOauth {
...
export class ZohoMailOauth {
    protected readonly _options: ZohoMailOauth.Options;

    constructor(_options: ZohoMailOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeZohoMailRequest} request
     * @param {ZohoMailOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *     })
     */
    public authorizeZohoMail(
        request: Klavis.AuthorizeZohoMailRequest,
        requestOptions?: ZohoMailOauth.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__authorizeZohoMail(request, requestOptions));
    }

    private async __authorizeZohoMail(
        request: Klavis.AuthorizeZohoMailRequest,
        requestOptions?: ZohoMailOauth.RequestOptions,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/zoho-mail/authorize.");
            case "unknown":
                throw new errors.KlavisError({
