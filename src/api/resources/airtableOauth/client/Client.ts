...
export declare namespace AirtableOauth {
...
export class AirtableOauth {
    protected readonly _options: AirtableOauth.Options;

    constructor(_options: AirtableOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeAirtableRequest} request
     * @param {AirtableOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.AirtableOAuthCallbackRequest} request
     * @param {AirtableOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public airtableOAuthCallback(
        request: Klavis.AirtableOAuthCallbackRequest = {},
        requestOptions?: AirtableOauth.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__airtableOAuthCallback(request, requestOptions));
    }

    private async __airtableOAuthCallback(
        request: Klavis.AirtableOAuthCallbackRequest = {},
        requestOptions?: AirtableOauth.RequestOptions,
    ): Promise<core.WithRawResponse<unknown>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/airtable/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *
     * @param {Klavis.RefreshAirtableTokenOauthAirtableRefreshTokenPostRequest} request
     * @param {AirtableOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Klavis.BadRequestError}
     * @throws {@link Klavis.UnprocessableEntityError}
     ...
     *     })
     */
    public refreshAirtableToken(
        request: Klavis.RefreshAirtableTokenOauthAirtableRefreshTokenPostRequest,
        requestOptions?: AirtableOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.AirtableOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__refreshAirtableToken(request, requestOptions));
    }

    private async __refreshAirtableToken(
        request: Klavis.RefreshAirtableTokenOauthAirtableRefreshTokenPostRequest,
        requestOptions?: AirtableOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.AirtableOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.AirtableOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError(
                    "Timeout exceeded when calling POST /oauth/airtable/refresh_token.",
                );
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
