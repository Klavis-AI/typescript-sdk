...
export class GithubOauth {
     ...
     *
     * @param {Klavis.GithubOAuthCallbackRequest} request
     * @param {GithubOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public githubOAuthCallback(
        request: Klavis.GithubOAuthCallbackRequest = {},
        requestOptions?: GithubOauth.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__githubOAuthCallback(request, requestOptions));
    }

    private async __githubOAuthCallback(
        request: Klavis.GithubOAuthCallbackRequest = {},
        requestOptions?: GithubOauth.RequestOptions,
    ): Promise<core.WithRawResponse<unknown>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/github/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
