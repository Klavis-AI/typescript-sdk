...
export declare namespace GitlabOauth {
...
export class GitlabOauth {
    protected readonly _options: GitlabOauth.Options;

    constructor(_options: GitlabOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeGitlabRequest} request
     * @param {GitlabOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
