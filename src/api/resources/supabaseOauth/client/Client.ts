...
export declare namespace SupabaseOauth {
...
export class SupabaseOauth {
    protected readonly _options: SupabaseOauth.Options;

    constructor(_options: SupabaseOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeSupabaseRequest} request
     * @param {SupabaseOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.SupabaseOAuthCallbackRequest} request
     * @param {SupabaseOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public supabaseOAuthCallback(
        request: Klavis.SupabaseOAuthCallbackRequest = {},
        requestOptions?: SupabaseOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.SupabaseOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__supabaseOAuthCallback(request, requestOptions));
    }

    private async __supabaseOAuthCallback(
        request: Klavis.SupabaseOAuthCallbackRequest = {},
        requestOptions?: SupabaseOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.SupabaseOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.SupabaseOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/supabase/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *
     * @param {Klavis.RefreshSupabaseTokenOauthSupabaseRefreshTokenPostRequest} request
     * @param {SupabaseOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Klavis.BadRequestError}
     * @throws {@link Klavis.UnprocessableEntityError}
     ...
     *     })
     */
    public refreshSupabaseToken(
        request: Klavis.RefreshSupabaseTokenOauthSupabaseRefreshTokenPostRequest,
        requestOptions?: SupabaseOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.SupabaseOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__refreshSupabaseToken(request, requestOptions));
    }

    private async __refreshSupabaseToken(
        request: Klavis.RefreshSupabaseTokenOauthSupabaseRefreshTokenPostRequest,
        requestOptions?: SupabaseOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.SupabaseOAuthSuccessResponse>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError(
                    "Timeout exceeded when calling POST /oauth/supabase/refresh_token.",
                );
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
