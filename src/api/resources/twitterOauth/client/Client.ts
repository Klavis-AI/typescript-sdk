...
export declare namespace TwitterOauth {
...
export class TwitterOauth {
    protected readonly _options: TwitterOauth.Options;

    constructor(_options: TwitterOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeTwitterRequest} request
     * @param {TwitterOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public authorizeTwitter(
        ...
        return core.HttpResponsePromise.fromPromise(this.__authorizeTwitter(request, requestOptions));
    }

    private async __authorizeTwitter(
        request: Klavis.AuthorizeTwitterRequest,
        requestOptions?: TwitterOauth.RequestOptions,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/twitter/authorize.");
            case "unknown":
                throw new errors.KlavisError({
