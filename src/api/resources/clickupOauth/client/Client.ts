...
export class ClickupOauth {
     ...
     *
     * @param {Klavis.ClickUpOAuthCallbackRequest} request
     * @param {ClickupOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public clickUpOAuthCallback(
        request: Klavis.ClickUpOAuthCallbackRequest = {},
        requestOptions?: ClickupOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.ClickUpOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__clickUpOAuthCallback(request, requestOptions));
    }

    private async __clickUpOAuthCallback(
        request: Klavis.ClickUpOAuthCallbackRequest = {},
        requestOptions?: ClickupOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.ClickUpOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.ClickUpOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/clickup/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
