...
export declare namespace PagerdutyOauth {
...
export class PagerdutyOauth {
    protected readonly _options: PagerdutyOauth.Options;

    constructor(_options: PagerdutyOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizePagerDutyRequest} request
     * @param {PagerdutyOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
