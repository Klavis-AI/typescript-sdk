...
export declare namespace SalesforceOauth {
...
export class SalesforceOauth {
    protected readonly _options: SalesforceOauth.Options;

    constructor(_options: SalesforceOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeSalesforceRequest} request
     * @param {SalesforceOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.SalesforceOAuthCallbackRequest} request
     * @param {SalesforceOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public salesforceOAuthCallback(
        request: Klavis.SalesforceOAuthCallbackRequest = {},
        requestOptions?: SalesforceOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.SalesforceOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__salesforceOAuthCallback(request, requestOptions));
    }

    private async __salesforceOAuthCallback(
        request: Klavis.SalesforceOAuthCallbackRequest = {},
        requestOptions?: SalesforceOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.SalesforceOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Klavis.SalesforceOAuthSuccessResponse,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/salesforce/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *
     * @param {Klavis.RefreshSalesforceTokenOauthSalesforceRefreshTokenPostRequest} request
     * @param {SalesforceOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Klavis.BadRequestError}
     * @throws {@link Klavis.UnprocessableEntityError}
     ...
     *     })
     */
    public refreshSalesforceToken(
        request: Klavis.RefreshSalesforceTokenOauthSalesforceRefreshTokenPostRequest,
        requestOptions?: SalesforceOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.SalesforceOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__refreshSalesforceToken(request, requestOptions));
    }

    private async __refreshSalesforceToken(
        request: Klavis.RefreshSalesforceTokenOauthSalesforceRefreshTokenPostRequest,
        requestOptions?: SalesforceOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.SalesforceOAuthSuccessResponse>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError(
                    "Timeout exceeded when calling POST /oauth/salesforce/refresh_token.",
                );
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
