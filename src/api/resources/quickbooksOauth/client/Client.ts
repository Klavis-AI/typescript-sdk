...
export declare namespace QuickbooksOauth {
...
export class QuickbooksOauth {
    protected readonly _options: QuickbooksOauth.Options;

    constructor(_options: QuickbooksOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeQuickBooksRequest} request
     * @param {QuickbooksOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
