...
export declare namespace FigmaOauth {
...
export class FigmaOauth {
    protected readonly _options: FigmaOauth.Options;

    constructor(_options: FigmaOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeFigmaRequest} request
     * @param {FigmaOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
