...
export declare namespace SlackOauth {
...
export class SlackOauth {
    protected readonly _options: SlackOauth.Options;

    constructor(_options: SlackOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeSlackRequest} request
     * @param {SlackOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.SlackOAuthCallbackRequest} request
     * @param {SlackOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public slackOAuthCallback(
        request: Klavis.SlackOAuthCallbackRequest = {},
        requestOptions?: SlackOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.SlackOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__slackOAuthCallback(request, requestOptions));
    }

    private async __slackOAuthCallback(
        request: Klavis.SlackOAuthCallbackRequest = {},
        requestOptions?: SlackOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.SlackOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.SlackOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/slack/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
