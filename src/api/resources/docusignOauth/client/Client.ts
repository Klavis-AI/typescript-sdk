...
export declare namespace DocusignOauth {
...
export class DocusignOauth {
    protected readonly _options: DocusignOauth.Options;

    constructor(_options: DocusignOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeDocuSignRequest} request
     * @param {DocusignOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
