...
export declare namespace LinkedinOauth {
...
export class LinkedinOauth {
    protected readonly _options: LinkedinOauth.Options;

    constructor(_options: LinkedinOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeLinkedInRequest} request
     * @param {LinkedinOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.LinkedinOAuthCallbackRequest} request
     * @param {LinkedinOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public linkedinOAuthCallback(
        request: Klavis.LinkedinOAuthCallbackRequest = {},
        requestOptions?: LinkedinOauth.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__linkedinOAuthCallback(request, requestOptions));
    }

    private async __linkedinOAuthCallback(
        request: Klavis.LinkedinOAuthCallbackRequest = {},
        requestOptions?: LinkedinOauth.RequestOptions,
    ): Promise<core.WithRawResponse<unknown>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/linkedin/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
