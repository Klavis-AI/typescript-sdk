...
export declare namespace VercelOauth {
...
export class VercelOauth {
    protected readonly _options: VercelOauth.Options;

    constructor(_options: VercelOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeVercelRequest} request
     * @param {VercelOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
