...
export declare namespace LinearOauth {
...
export class LinearOauth {
    protected readonly _options: LinearOauth.Options;

    constructor(_options: LinearOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeLinearRequest} request
     * @param {LinearOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.LinearOAuthCallbackRequest} request
     * @param {LinearOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public linearOAuthCallback(
        request: Klavis.LinearOAuthCallbackRequest = {},
        requestOptions?: LinearOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.LinearOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__linearOAuthCallback(request, requestOptions));
    }

    private async __linearOAuthCallback(
        request: Klavis.LinearOAuthCallbackRequest = {},
        requestOptions?: LinearOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.LinearOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.LinearOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/linear/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
