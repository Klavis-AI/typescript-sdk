...
export declare namespace StripeConnectOauth {
...
export class StripeConnectOauth {
    protected readonly _options: StripeConnectOauth.Options;

    constructor(_options: StripeConnectOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeStripeConnectRequest} request
     * @param {StripeConnectOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public authorizeStripeConnect(
        ...
        return core.HttpResponsePromise.fromPromise(this.__authorizeStripeConnect(request, requestOptions));
    }

    private async __authorizeStripeConnect(
        request: Klavis.AuthorizeStripeConnectRequest,
        requestOptions?: StripeConnectOauth.RequestOptions,
