...
export declare namespace GsheetsOauth {
...
export class GsheetsOauth {
    protected readonly _options: GsheetsOauth.Options;

    constructor(_options: GsheetsOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeGSheetsRequest} request
     * @param {GsheetsOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.GsheetsOAuthCallbackRequest} request
     * @param {GsheetsOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public gsheetsOAuthCallback(
        request: Klavis.GsheetsOAuthCallbackRequest = {},
        requestOptions?: GsheetsOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.GSheetsOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__gsheetsOAuthCallback(request, requestOptions));
    }

    private async __gsheetsOAuthCallback(
        request: Klavis.GsheetsOAuthCallbackRequest = {},
        requestOptions?: GsheetsOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.GSheetsOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.GSheetsOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/gsheets/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *
     * @param {Klavis.RefreshGsheetsTokenOauthGsheetsRefreshTokenPostRequest} request
     * @param {GsheetsOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Klavis.BadRequestError}
     * @throws {@link Klavis.UnprocessableEntityError}
     ...
     *     })
     */
    public refreshGsheetsToken(
        request: Klavis.RefreshGsheetsTokenOauthGsheetsRefreshTokenPostRequest,
        requestOptions?: GsheetsOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.GSheetsOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__refreshGsheetsToken(request, requestOptions));
    }

    private async __refreshGsheetsToken(
        request: Klavis.RefreshGsheetsTokenOauthGsheetsRefreshTokenPostRequest,
        requestOptions?: GsheetsOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.GSheetsOAuthSuccessResponse>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling POST /oauth/gsheets/refresh_token.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
