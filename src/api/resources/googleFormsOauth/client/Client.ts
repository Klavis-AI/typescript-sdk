...
export declare namespace GoogleFormsOauth {
...
export class GoogleFormsOauth {
    protected readonly _options: GoogleFormsOauth.Options;

    constructor(_options: GoogleFormsOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeGoogleFormsRequest} request
     * @param {GoogleFormsOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *     })
     */
    public authorizeGoogleForms(
        request: Klavis.AuthorizeGoogleFormsRequest,
        requestOptions?: GoogleFormsOauth.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__authorizeGoogleForms(request, requestOptions));
    }

    private async __authorizeGoogleForms(
        request: Klavis.AuthorizeGoogleFormsRequest,
        requestOptions?: GoogleFormsOauth.RequestOptions,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/google-forms/authorize.");
            case "unknown":
                throw new errors.KlavisError({
