...
export declare namespace ConfluenceOauth {
...
export class ConfluenceOauth {
    protected readonly _options: ConfluenceOauth.Options;

    constructor(_options: ConfluenceOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeConfluenceRequest} request
     * @param {ConfluenceOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.ConfluenceOAuthCallbackRequest} request
     * @param {ConfluenceOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public confluenceOAuthCallback(
        request: Klavis.ConfluenceOAuthCallbackRequest = {},
        requestOptions?: ConfluenceOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.ConfluenceOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__confluenceOAuthCallback(request, requestOptions));
    }

    private async __confluenceOAuthCallback(
        request: Klavis.ConfluenceOAuthCallbackRequest = {},
        requestOptions?: ConfluenceOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.ConfluenceOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Klavis.ConfluenceOAuthSuccessResponse,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/confluence/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *
     * @param {Klavis.RefreshConfluenceTokenOauthConfluenceRefreshTokenPostRequest} request
     * @param {ConfluenceOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Klavis.BadRequestError}
     * @throws {@link Klavis.UnprocessableEntityError}
     ...
     *     })
     */
    public refreshConfluenceToken(
        request: Klavis.RefreshConfluenceTokenOauthConfluenceRefreshTokenPostRequest,
        requestOptions?: ConfluenceOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.ConfluenceOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__refreshConfluenceToken(request, requestOptions));
    }

    private async __refreshConfluenceToken(
        request: Klavis.RefreshConfluenceTokenOauthConfluenceRefreshTokenPostRequest,
        requestOptions?: ConfluenceOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.ConfluenceOAuthSuccessResponse>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError(
                    "Timeout exceeded when calling POST /oauth/confluence/refresh_token.",
                );
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
