...
export declare namespace KlaviyoOauth {
...
export class KlaviyoOauth {
    protected readonly _options: KlaviyoOauth.Options;

    constructor(_options: KlaviyoOauth.Options = {}) {
        this._options = _options;
    }

    /**
     * @param {Klavis.AuthorizeKlaviyoRequest} request
     * @param {KlaviyoOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
