...
export declare namespace InstagramOauth {
...
export class InstagramOauth {
    protected readonly _options: InstagramOauth.Options;

    constructor(_options: InstagramOauth.Options = {}) {
        this._options = _options;
    }

    /**
     * @param {Klavis.AuthorizeInstagramRequest} request
     * @param {InstagramOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *     })
     */
    public authorizeInstagram(
        request: Klavis.AuthorizeInstagramRequest,
        requestOptions?: InstagramOauth.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__authorizeInstagram(request, requestOptions));
    }

    private async __authorizeInstagram(
        request: Klavis.AuthorizeInstagramRequest,
        requestOptions?: InstagramOauth.RequestOptions,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/instagram/authorize.");
            case "unknown":
                throw new errors.KlavisError({
