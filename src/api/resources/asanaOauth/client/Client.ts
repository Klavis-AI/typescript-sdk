...
export declare namespace AsanaOauth {
...
export class AsanaOauth {
    protected readonly _options: AsanaOauth.Options;

    constructor(_options: AsanaOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeAsanaRequest} request
     * @param {AsanaOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.AsanaOAuthCallbackRequest} request
     * @param {AsanaOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public asanaOAuthCallback(
        request: Klavis.AsanaOAuthCallbackRequest = {},
        requestOptions?: AsanaOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.AsanaOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__asanaOAuthCallback(request, requestOptions));
    }

    private async __asanaOAuthCallback(
        request: Klavis.AsanaOAuthCallbackRequest = {},
        requestOptions?: AsanaOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.AsanaOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.AsanaOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/asana/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *
     * @param {Klavis.RefreshAsanaTokenOauthAsanaRefreshTokenPostRequest} request
     * @param {AsanaOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Klavis.BadRequestError}
     * @throws {@link Klavis.UnprocessableEntityError}
     ...
     *     })
     */
    public refreshAsanaToken(
        request: Klavis.RefreshAsanaTokenOauthAsanaRefreshTokenPostRequest,
        requestOptions?: AsanaOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.AsanaOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__refreshAsanaToken(request, requestOptions));
    }

    private async __refreshAsanaToken(
        request: Klavis.RefreshAsanaTokenOauthAsanaRefreshTokenPostRequest,
        requestOptions?: AsanaOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.AsanaOAuthSuccessResponse>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling POST /oauth/asana/refresh_token.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
