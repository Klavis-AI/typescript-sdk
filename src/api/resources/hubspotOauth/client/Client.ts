...
export declare namespace HubspotOauth {
...
export class HubspotOauth {
    protected readonly _options: HubspotOauth.Options;

    constructor(_options: HubspotOauth.Options = {}) {
     ...
     *
     * @param {Klavis.AuthorizeHubspotRequest} request
     * @param {HubspotOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @param {Klavis.HubspotOAuthCallbackRequest} request
     * @param {HubspotOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public hubspotOAuthCallback(
        request: Klavis.HubspotOAuthCallbackRequest = {},
        requestOptions?: HubspotOauth.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__hubspotOAuthCallback(request, requestOptions));
    }

    private async __hubspotOAuthCallback(
        request: Klavis.HubspotOAuthCallbackRequest = {},
        requestOptions?: HubspotOauth.RequestOptions,
    ): Promise<core.WithRawResponse<unknown>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling GET /oauth/hubspot/callback.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *
     * @param {Klavis.RefreshHubspotTokenOauthHubspotRefreshTokenPostRequest} request
     * @param {HubspotOauth.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Klavis.BadRequestError}
     * @throws {@link Klavis.UnprocessableEntityError}
     ...
     *     })
     */
    public refreshHubspotToken(
        request: Klavis.RefreshHubspotTokenOauthHubspotRefreshTokenPostRequest,
        requestOptions?: HubspotOauth.RequestOptions,
    ): core.HttpResponsePromise<Klavis.HubSpotOAuthSuccessResponse> {
        return core.HttpResponsePromise.fromPromise(this.__refreshHubspotToken(request, requestOptions));
    }

    private async __refreshHubspotToken(
        request: Klavis.RefreshHubspotTokenOauthHubspotRefreshTokenPostRequest,
        requestOptions?: HubspotOauth.RequestOptions,
    ): Promise<core.WithRawResponse<Klavis.HubSpotOAuthSuccessResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Klavis.HubSpotOAuthSuccessResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.KlavisTimeoutError("Timeout exceeded when calling POST /oauth/hubspot/refresh_token.");
            case "unknown":
                throw new errors.KlavisError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
