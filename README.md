...
A full reference for this library is available [here](https://github.com/Klavis-AI/typescript-sdk/blob/HEAD/./reference.md).
...
const request: Klavis.CallToolRequest = {
    ...
};
```
...
```typescript
const { data, rawResponse } = await client.mcpServer.callTools(...).withRawResponse();
