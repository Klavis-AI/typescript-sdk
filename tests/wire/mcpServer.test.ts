...
describe("McpServer", () => {
    ...
    test("listStrataRawActions", async () => {
        const server = mockServerPool.createServer();
        const client = new KlavisClient({ apiKey: "test", environment: server.baseUrl });

        const rawResponseBody = { strataId: "strataId", server: "server", result: { key: "value" } };
        server
            .mockEndpoint()
        ...
        const response = await client.mcpServer.listStrataRawActions("strataId", {
            server: "Affinity",
        });
        expect(response).toEqual({
            strataId: "strataId",
    ...
    test("updateServerInstance", async () => {
        const server = mockServerPool.createServer();
        const client = new KlavisClient({ apiKey: "test", environment: server.baseUrl });
        const rawRequestBody = {};
        const rawResponseBody = { instanceId: "instanceId", isReadOnly: true, message: "message" };
        server
            .mockEndpoint()
        ...
        const response = await client.mcpServer.updateServerInstance("instanceId");
        expect(response).toEqual({
            instanceId: "instanceId",
            isReadOnly: true,
            message: "message",
